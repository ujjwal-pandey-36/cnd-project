...
const navigation = [
        ...
        submenu: [
          ...
          { 
            ...
            submenu: [
              ...
              { name: 'Invoice Charge Accounts', href: '/settings/items/invoice-charge-accounts' }
            ]
          },
          { 
          ...
          { name: 'Financial Statement', href: '/settings/financial-statement' },
  ...
  { 
    ...
    submenu: [
      ...
      { name: 'Journal Entry Voucher', href: '/disbursement/journal-entry-vouchers' },
      { name: 'Disbursement Journals', href: '/disbursement/disbursement-journals' },
      ...
      { name: 'Fund Utilization Request', href: '/disbursement/fund-utilization-requests' }
    ]
  },
  { 
    name: 'Collections', 
    ...
    submenu: [
      ...
      { name: 'Community Tax Corporation', href: '/collections/community-tax-corporation' },
  ...
  { 
    ...
    submenu: [
      ...
      { name: 'Statement of Appropriation, Allotment, Obligation, Balances', href: '/budget/statement-appropriation' }
    ]
  },
  { 
    name: 'Applications', 
...
function SidebarMenu({ items, expandedMenus, toggleMenu, isActive, isSubMenuActive, level = 0 }) {
  return (
