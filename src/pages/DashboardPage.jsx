...
const StatCard = ({ title, value, icon: Icon, trend, trendValue, trendLabel, loading }) => (
            ...
            <dd>
              {loading ? (
                ...
                <div className="flex items-baseline">
                  ...
                  {trendValue && (
                    <div className={`ml-2 flex items-baseline text-sm font-semibold ${trend === 'up' ? 'text-success-600' : 'text-error-600'}`}>
                      {trend === 'up' ? (
  ...
  <div className="flex py-3 px-4 hover:bg-neutral-50 transition-colors rounded-md">
    <div className={`
      ...
      ${status === 'pending' ? 'bg-warning-100 text-warning-600' : 
        ...
        status === 'rejected' ? 'bg-error-100 text-error-600' : 'bg-neutral-100 text-neutral-600'}
    `}>
